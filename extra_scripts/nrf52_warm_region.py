...
#
# The top 8 flash pages of the app region (0xE5000-0xED000, reclaimed by
# whole-image LTO) are reserved for the WarmNodeStore's two ping-pong copies
# (src/mesh/WarmNodeStore.h). Our own linker script
# (src/platform/nrf52/nrf52840_s140_v7.ld) already caps the image at 0xE5000,
...
WARM_REGION_BASE = 0xE5000  # keep in sync with WARM_FLASH_REGION_BASE in WarmNodeStore.h
...
def _assert_warm_region_clear(source, target, env):
    ...
    if flash_end > WARM_REGION_BASE:
        sys.stderr.write(
            ...
            "The top 8 flash pages hold the WarmNodeStore ping-pong copies; a warm-store\n"
