...
class Rig:
    ...
    def on_log(self, line, interface):
        ...
        if n and ("frequency offset" in line or "CAD" in line or "busy" in line.lower() or "BENCH" in line
                  or "RSSI look" in line or "Ignore rx packet" in line or "stale" in line or "Preamble" in line):
...
def main():
    ...
    pk = sub.add_parser("peek"); pk.add_argument("key"); pk.add_argument("variants", help="JSON file of peek variants")
