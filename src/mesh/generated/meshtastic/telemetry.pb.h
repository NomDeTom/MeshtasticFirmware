...
typedef enum _meshtastic_TelemetrySensorType {
    ...
    /* Low accuracy current and voltage during charging */
    meshtastic_TelemetrySensorType_BQ25895 = 46
...
#define _meshtastic_TelemetrySensorType_MAX meshtastic_TelemetrySensorType_BQ25895
#define _meshtastic_TelemetrySensorType_ARRAYSIZE ((meshtastic_TelemetrySensorType)(meshtastic_TelemetrySensorType_BQ25895+1))
