...
#if defined(HELTEC_MESH_POCKET_BATTERY_5000) || defined(HELTEC_MESH_POCKET_BATTERY_10000)
#define OCV_ARRAY 4150, 4070, 3980, 3910, 3850, 3810, 3780, 3750, 3720, 3670, 3100
#endif
