...
sys.path.insert(0, "/home/user/MeshtasticFirmware/sim")
import matplotlib
...
from sfpp.campaign import Placement
...
GRID = "#e3e3e0"
BG = "#FCFCFA"
OUT = "/home/user/notes-sync/MeshtasticFirmware/2026-08-17-sfpp-sr-sweep/figures3"
RUNS = "/home/user/notes-sync/MeshtasticFirmware/2026-08-17-sfpp-sr-sweep/runs3"
...
g = lambda v, p, k: statistics.mean(r[p][k] for r in d if r["value"] == v)
labels = ["none\n(no archive)", "chain\n(today's SF++)", "sr\n(sketch)"]
...
air = [
    0,
    100 * g("chain", "sfpp", "sr_airtime_share"),
    100 * g("sr", "sfpp", "sr_airtime_share"),
]
...
adv = [0, g("chain", "sfpp", "adverts"), g("sr", "sfpp", "adverts")]
...
rec = [g(v, "baseline", "text_reception_mean") for v in ("none", "chain", "sr")]
...
ax.set_facecolor(BG)
node = g("sr", "baseline", "text_reception_mean")
union = g("sr", "sfpp", "union_fraction")
ax.barh(
